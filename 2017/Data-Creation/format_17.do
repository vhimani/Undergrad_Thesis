...
cd "\\cnsdisk.austin.utexas.edu\home\hv3793\Desktop\Time-Use-Great-Recession\2017\Basic-Transformed-Data-Files";

/******************/

/*Extract needed variables from cps, roster, and respondent files*/

use atuscps_2017, clear;
...
save "timeuse_2017", replace;


use atusrost_2017, clear;
...
merge tucaseid tulineno using "timeuse_2017", unique nokeep;
...
save "17_subset", replace;

save "\\cnsdisk.austin.utexas.edu\home\hv3793\Desktop\Time-Use-Great-Recession\ALL\17_subset.dta", replace;
