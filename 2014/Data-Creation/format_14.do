...
cd "\\cnsdisk.austin.utexas.edu\home\hv3793\Desktop\Time-Use-Great-Recession\2014\Basic-Transformed-Data-Files";

/******************/

/*Extract needed variables from cps, roster, and respondent files*/

use atuscps_2014, clear;
...
save "timeuse_2014", replace;


use atusrost_2014, clear;
...
merge tucaseid tulineno using "timeuse_2014", unique nokeep;
...
merge tucaseid using "timeuse_2014";
...
save "14_subset", replace;

save "\\cnsdisk.austin.utexas.edu\home\hv3793\Desktop\Time-Use-Great-Recession\ALL\14_subset.dta", replace;
