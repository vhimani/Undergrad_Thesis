...
cd "\\cnsdisk.austin.utexas.edu\home\hv3793\Desktop\Time-Use-Great-Recession\2020\Basic-Transformed-Data-Files";

/******************/

/*Extract needed variables from cps, roster, and respondent files*/

use atuscps_2020, clear;
...
save "timeuse_2020", replace;


use atusrost_2020, clear;
...
merge tucaseid tulineno using "timeuse_2020", unique nokeep;
...
use "atusresp_2020", clear;

keep tulk tufwk tulay tudis tuabsot teret telfs trchildnum trdpftpt trsppres tryhhchild
tucaseid tudiaryday tudiarydate tumonth tuyear tulineno turetot tuyear telfs trernwa teschft teschenr tehruslt 
trernhly tespempnot tespuhrs tu20fwgt;
...
homemaker work_part hh_income wage_03 wage_03_alt year dataset interview_day interview_date  gestfips gereg tu20fwgt
...
save "20_subset", replace;

save "\\cnsdisk.austin.utexas.edu\home\hv3793\Desktop\Time-Use-Great-Recession\ALL\20_subset.dta", replace;
