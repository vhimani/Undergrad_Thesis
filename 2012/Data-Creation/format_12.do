...
cd "\\cnsdisk.austin.utexas.edu\home\hv3793\Desktop\Time-Use-Great-Recession\2012\Basic-Transformed-Data-Files";

/******************/

/*Extract needed variables from cps, roster, and respondent files*/

use atuscps_2012, clear;
...
save "timeuse_2012", replace;


use atusrost_2012, clear;
...
merge tucaseid tulineno using "timeuse_2012", unique nokeep;
...
save "12_subset", replace;

save "\\cnsdisk.austin.utexas.edu\home\hv3793\Desktop\Time-Use-Great-Recession\ALL\12_subset.dta", replace;
