...
cd "\\cnsdisk.austin.utexas.edu\home\hv3793\Desktop\Time-Use-Great-Recession\2016\Basic-Transformed-Data-Files";

/******************/

/*Extract needed variables from cps, roster, and respondent files*/

use atuscps_2016, clear;
...
save "timeuse_2016", replace;


use atusrost_2016, clear;
...
merge tucaseid tulineno using "timeuse_2016", unique nokeep;
...
save "16_subset", replace;

save "\\cnsdisk.austin.utexas.edu\home\hv3793\Desktop\Time-Use-Great-Recession\ALL\16_subset.dta", replace;
