...
cd "\\cnsdisk.austin.utexas.edu\home\hv3793\Desktop\Time-Use-Great-Recession\2015\Basic-Transformed-Data-Files";

/******************/

/*Extract needed variables from cps, roster, and respondent files*/

use atuscps_2015, clear;
...
save "timeuse_2015", replace;


use atusrost_2015, clear;
...
merge tucaseid tulineno using "timeuse_2015", unique nokeep;
...
save "15_subset", replace;

save "\\cnsdisk.austin.utexas.edu\home\hv3793\Desktop\Time-Use-Great-Recession\ALL\15_subset.dta", replace;
