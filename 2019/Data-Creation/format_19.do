...
cd "\\cnsdisk.austin.utexas.edu\home\hv3793\Desktop\Time-Use-Great-Recession\2019\Basic-Transformed-Data-Files";

/******************/

/*Extract needed variables from cps, roster, and respondent files*/

use atuscps_2019, clear;
...
save "timeuse_2019", replace;


use atusrost_2019, clear;
...
merge tucaseid tulineno using "timeuse_2019", unique nokeep;
...
save "19_subset", replace;

save "\\cnsdisk.austin.utexas.edu\home\hv3793\Desktop\Time-Use-Great-Recession\ALL\19_subset.dta", replace;
