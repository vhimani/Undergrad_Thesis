...
cd "\\cnsdisk.austin.utexas.edu\home\hv3793\Desktop\Time-Use-Great-Recession\2011\Basic-Transformed-Data-Files";

/******************/

/*Extract needed variables from cps, roster, and respondent files*/

use atuscps_2011, clear;
...
save "timeuse_2011", replace;


use atusrost_2011, clear;
...
merge tucaseid tulineno using "timeuse_2011", unique nokeep;
...
save "11_subset", replace;

save "\\cnsdisk.austin.utexas.edu\home\hv3793\Desktop\Time-Use-Great-Recession\ALL\11_subset.dta", replace;
