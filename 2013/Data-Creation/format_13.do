...
cd "\\cnsdisk.austin.utexas.edu\home\hv3793\Desktop\Time-Use-Great-Recession\2013\Basic-Transformed-Data-Files";

/******************/

/*Extract needed variables from cps, roster, and respondent files*/

use atuscps_2013, clear;
...
save "timeuse_2013", replace;


use atusrost_2013, clear;
...
merge tucaseid tulineno using "timeuse_2013", unique nokeep;
...
save "13_subset", replace;

save "\\cnsdisk.austin.utexas.edu\home\hv3793\Desktop\Time-Use-Great-Recession\ALL\13_subset.dta", replace;
